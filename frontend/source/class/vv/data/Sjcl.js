/* ***********************************************************************
   ...
   A qooxdoo wrapper for Stanford Javascript Crypto Library
...
qx.Class.define("vv.data.Sjcl", {
    ...
    members : {
         ...
         * TODOC
         *
         * @param pass {var} TODOC
         * @param data {var} TODOC
         * @return {var} TODOC
         */
        encrypt : function(pass, data) {
            return sjcl.encrypt(pass, data);
        },
...
sjcl.codec.base64 = {
    ...
    toBits : function(a, b) {
        a = a.replace(/\s|=/g, "");
        var c = [], d = 0, e = sjcl.codec.base64.D, f = 0, g;
